export const icons = {
  ...
  NextJS: { className: "devicon-nextjs-plain", color: "#010101" },
  Redux: { className: "devicon-redux-original", color: "#764ABC" },
  SocketIO: { className: "devicon-socketio-original", color: "#010101" },
  swiper: { className: "devicon-swiper-original", color: "#6332F6" },
  radixui: { svgLink: "/icons/radixui.svg", color: "#000000" },
  lucide: { svgLink: "/icons/lucide.svg", color: "#8B5CF6" },
  vercel: { className: "devicon-vercel-original", color: "#010101" },
